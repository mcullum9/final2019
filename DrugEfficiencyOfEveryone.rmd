...
Our p-value is 2.2e-16 for the chi-square test and 2.333e-07 for the fisher test. This means the probability of getting a sample like this under conditions when the null hypothesis is true is about 0% . Our p-valueis less than our threshold of belief which is .05 percent. Since the p-value is less than .05 we reject the null hypothesis and conclude that there is a difference between taking the drug or taking the placebo and getting aids for everyone. This data shows that taking the drug ios effective in preventing aids for everyone. This data also indicates that taking a drug has a positive effect for everyone. 
